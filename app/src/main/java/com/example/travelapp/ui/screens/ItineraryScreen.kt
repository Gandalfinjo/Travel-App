...
fun ItineraryScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(R.string.daily_itinerary)) },
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.new_itinerary)
                )
            }
        },
        containerColor = Color.Transparent
                        ...
                        Card(
                            ...
                            Row(
                                ...
                                Checkbox(
                                    ...
                                    onCheckedChange = {
                                        itineraryViewModel.updateItem(itineraryItem.copy(isDone = it))
                                    },
